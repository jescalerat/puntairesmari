...
<?
	...
	if (isset($_POST['op_fiestas']))
  {
  	...
  	$query="insert into cronicas (fiestas_IdFiesta,fiestas_municipios_provincias_comunidades_IdComunidad,fiestas_municipios_provincias_IdProvincia,fiestas_municipios_IdMunicipio,Cronica,fiestas_municipios_provincias_comunidades_paises_IdPais) values (".$idfiesta.",".$idcomunidad.",".$idprovincia.",".$idmunicipio.",\"".$cronica."\",1)";
    $qresultado=mysql_query ($query,$link);
		...
		print ("<table border=\"0\" width=\"100%\">");
			print("<tr>");
				...
				print("<td><a href=\"gestionar_cronicas.php\">Otra cronica</a></td>");
			print("</tr>");
		print("</table>");
  }
  else
  {
		print	("<form name=\"programas\" id=\"programas\" method=\"post\">");
	  	...
	  	{
		  	$query="select IdFiesta,municipios_provincias_comunidades_IdComunidad, municipios_provincias_IdProvincia, municipios_IdMunicipio from fiestas where IdFiesta not in (select fiestas_IdFiesta from cronicas) order by IdFiesta";
		...
		print ("<p>");
		print ("Cronica:<textarea rows=\"10\" cols=\"30\" name=\"cronica\" id=\"cronica\"></textarea>");
  	print ("<p>");
