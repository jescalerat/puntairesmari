<html>
	...
	<body>
		<form action="javascript:llamada_prototype('modificar_encuentro.php','principal',2);" method="post" name="encuentros" id="encuentros">
<?php
	...
	{
	    $query="delete from contactos_encuentros where IdEncuentro=".$_GET['ideliminar'];
	    mysqli_query($link, $query);
	    print ("<br>Delete: ".$query.";<br>");
	    
	    $query="delete from carteles where IdEncuentro=".$_GET['ideliminar'];
	    mysqli_query($link, $query);
	    print ("<br>Delete: ".$query.";<br>");
	    
	    $query="delete from encuentros where IdEncuentro=".$_GET['ideliminar'];
	    mysqli_query($link, $query);
	    print ("<br>Delete: ".$query.";<br>");
	}
	...
	if (isset($_POST['idEncuentro']))
	{
	    ...
	    $query="update encuentros set Descripcion='".$descripcion."', Dia=".$dia.", Mes=".$mes.", Anyo=".$anyo." where IdEncuentro=".$_POST['idEncuentro'];
...
?>				
		...
		<p>
			<input type="submit" name="enviar" id="enviar" value="Buscar encuentro" onclick="return ejecutarAccion('modificar_encuentro.php');"/>
		</p>
...
?>				
						<tr>
							<td><a href="javascript:llamada_prototype('modificar_encuentro.php?IdEncuentro=<?= $encuentros["IdEncuentro"] ?>','principal');"><?= cambiarAcentos($desc) ?></a></td>
							<td><?= $dias ?></td>
							<td><a onclick="llamada_prototype('modificar_encuentro.php?ideliminar=<?= $encuentros["IdEncuentro"] ?>','principal');" href="#">Eliminar</a></td>
						</tr>
<?php 				
					}
?>			
...
?>
		...
		<p>
			<input type="submit" name="enviar" id="enviar" value="Guardar" onclick="return ejecutarAccion('modificar_encuentro.php');"/>
		</p>
<?php 			
	}
?>	
