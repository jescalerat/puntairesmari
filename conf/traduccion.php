<?php
	...
	else if ($idioma==3) //Catalan
	{
		...
		define ('_CONTACTAR','Si hi ha algun problema amb el formulari envieu un missatge a aquesta adreça <a href=mailto:puntairesmari@gmail.com>puntairesmari@gmail.com</a>. GrÃ cies');
